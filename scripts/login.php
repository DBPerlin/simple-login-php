        ...
        <div class="card bg-light p-5 shadow-mt-5">
            ...
            <form action="?rota=login_submit" method="post">
                <div class="mb-3">
                    ...
                    <input type="text" class="text_usuario" classe="form-control" required>
                </div>

                <div class="mb-3">
                    <label for="text_senha" class="form_label">Senha</label>
                    <input type="password" name="text_senha" class="form_control" required>
                </div>
                <div>
